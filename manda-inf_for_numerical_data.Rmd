...
#
The cases in this data set are in regards to Mothers and the birth of their children.
...
```
# Since the p-value is < 0.05... We  can reject our null hypothesis that the mothers age has impact on premie status.
