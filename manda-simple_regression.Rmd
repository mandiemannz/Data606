...
Hits are a better predictor. It's R2 value is 0.64 vs 0.37
...
All three of the "new" variables are better predictors - higher R2 scores. The best predictor is the new_obs variable.

```{r}
model3 <- lm(runs~new_onbase, mlb11)
summary(model3)



model4 <- lm(runs~new_slug, mlb11)
summary(model4)


model5 <- lm(runs~new_obs, mlb11)
summary(model5)
